...
class EmployeeTracker {
    ...
    async viewEmployeesByDepartment(name: string) {
        const result = await pool.query(`
            SELECT 
                employee.id AS "Employee ID",
                employee.first_name AS "First Name",
...
export default new EmployeeTracker();
